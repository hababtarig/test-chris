...
class OpenVpnCredsAddS3Job implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        if (!$controllerIp) {
            ...
            $task->save();
            Log::error('❌ OpenVpnCredsAddS3Job: Missing controller IP');
            return;
        }
        ...
        try {
            ...
            Log::info('✅ OpenVpnCredsAddS3Job executed', [
                'command'  => $sshCmd,
                'exitCode' => $exitCode,
                'output'   => $output,
            ]);
            ...
            Log::error('❌ OpenVpnCredsAddS3Job failed', [
